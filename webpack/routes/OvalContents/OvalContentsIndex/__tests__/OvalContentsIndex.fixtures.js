    ...
    result: {
      data: {
        ovalContents: {
          totalCount: 4,
          nodes: [
            { id: 'abc', name: 'ansible OVAL content', url: 'http://oval-content-source/security/data/oval/ansible-2-including-unpatched.oval.xml.bz2', originalFilename: '' },
            { id: 'bcd', name: 'dotnet OVAL content', url: 'http://oval-content-source/security/data/oval/dotnet-2.2.oval.xml.bz2', originalFilename: '' },
            { id: 'cde', name: 'jboss OVAL content', url: '', originalFilename: 'jboss.oval.xml.bz2' },
            { id: 'def', name: 'openshift OVAL content', url: '', originalFilename: 'openshift.oval.xml.bz2' },
          ]
        }
      }
    }
